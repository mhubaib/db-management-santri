    ...
    <div class="form-inner">
        <div class="form-header">
            <div class="form-title">
                <h2 class="text-2xl font-bold text-white mb-2">Edit Data Santri</h2>
                <p class="text-white text-opacity-90 text-sm">Perbarui informasi santri di formulir di bawah ini</p>
            </div>
        </div>
        ...
        <div class="p-8">
            ...
            <form action="{{ route('santri.update', $santri->id) }}" method="POST" id="santriForm">
                @csrf
                @method('PUT')
                ...
                <div class="form-grid">
                    ...
                    <div class="form-field">
                        ...
                        <div class="relative">
                            <input type="number" name="nis" id="nis" value="{{ old('nis', $santri->nis) }}" 
                    ...
                    <div class="form-field">
                        ...
                        <div class="relative">
                            <select name="kamar_id" id="kamar_id" class="form-select" required>
                                ...
                                @foreach ($kamar as $k)
                                    <option value="{{ $k->id }}" {{ old('kamar_id', $santri->kamar_id) == $k->id ? 'selected' : '' }}>
                                        {{ $k->nama_kamar }}
                                    </option>
                                @endforeach
                            </select>
                    ...
                    <div class="form-field">
                        ...
                        <div class="relative">
                            <input type="date" name="tgl_lahir" id="tgl_lahir" value="{{ old('tgl_lahir', $santri->tgl_lahir) }}" 
                    ...
                    <div class="form-field" style="grid-column: 1 / -1;">
                        ...
                        <div class="relative">
                            <textarea name="alamat_asal" id="alamat_asal" rows="4" 
                                      class="form-textarea" required placeholder="Masukkan alamat lengkap">{{ old('alamat_asal', $santri->alamat_asal) }}</textarea>
